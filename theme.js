(function ($) {
  ...
  if (
    navigator.userAgent.match(
      /(Opera Mini)|(534\.30)|(534\.13)|(530\.17)|(533\.1)/i
    )
  ) {
    if ($("nav.navbar").length) {
      ...
      $(".navbar-toggler:eq(0)")
        .addClass("collapsed")
        .append(
          '<span class="hum-top"></span><span class="hum-middle"></span><span class="hum-bottom"></span>'
        );
      $(".navbar-toggler span")
        .not(".close-icon")
...
!(function () {
  ...
  if (!document.getElementById("top-1")) {
    ...
    a.className = "engine";
    a.innerHTML =
      '<a href="https://mobirise.com">mobirise.com</a> Mobirise v3.12.1';
